...
import com.gongsoop.ai.service.AiGeneratedQuestionHistoryDeleteService;
...
public class AiController {
    ...
    private final AiGeneratedQuestionHistoryDeleteService
            historyDeleteService;

    public AiController(
            AiService aiService,
            AiGeneratedQuestionHistoryDeleteService historyDeleteService
    ) {
        this.aiService =
                aiService;
    ...
    public ApiResponse<AiChatSessionResponse> updateChatSessionTitle(
        ...
        return ApiResponse.success(
                "AI 채팅 세션 제목을 수정했습니다",
                aiService.updateChatSessionTitle(
                        email,
                        sessionId,
                        request
                )
    ...
    public ApiResponse<PageResponse<AiGeneratedQuestionSetSummaryResponse>>
    getGeneratedQuestionSets(
            @AuthenticationPrincipal
            String email,
        ...
        return ApiResponse.success(
                ...
                aiService.getGeneratedQuestionSets(
                        email,
                        page,
                        size
                )
    ...
    public ApiResponse<AiGeneratedQuestionSetDetailResponse>
    getGeneratedQuestionSetDetail(
            @AuthenticationPrincipal
            String email,
        ...
        return ApiResponse.success(
                ...
                aiService.getGeneratedQuestionSetDetail(
                        email,
                        setId
                )
        );
    ...
    public ApiResponse<SolveAiGeneratedQuestionResponse>
    solveGeneratedQuestion(
        ...
        return ApiResponse.success(
                "AI 생성 문제를 채점했습니다",
                aiService.solveGeneratedQuestion(
                        email,
                        generatedQuestionId,
                        request
                )
    ...
    public ApiResponse<PageResponse<AiGeneratedQuestionSolveRecordResponse>>
    getGeneratedQuestionSolveRecords(
            @AuthenticationPrincipal
            String email,
        ...
        return ApiResponse.success(
                ...
                aiService.getGeneratedQuestionSolveRecords(
                        email,
                        page,
                        size
                )
